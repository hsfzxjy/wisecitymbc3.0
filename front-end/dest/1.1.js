...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleEdit = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleList = __webpack_require__(25);
	...
	var AVAILABLE_CATEGORIES = ['government', 'company', 'media'];
	...
	exports.default = {
	    ...
	    data: function data() {
	        return {
	            categories: _lodash2.default.zipObject(AVAILABLE_CATEGORIES, CATEGORIES_NAME),
	            currentCategory: ''
	        };
	    },
	    route: {
	        data: function data(transition) {
	            ...
	            if (!(_lodash2.default.indexOf(AVAILABLE_CATEGORIES, category) >= 0)) category = 'government';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueInfiniteLoading = __webpack_require__(31);
	    ...
	    methods: {
	        reset: function reset() {
	            ...
	            this.$nextTick(function () {
	                _this2.$broadcast('$InfiniteLoading:reset');
	            });
	        },
	        load: function load() {
	            var _this3 = this;
	
	            if (this.nextURL === '') this.nextURL = '/api/articles/?article_type=' + _consts2.default.articles.ArticleType[this.category];
	            this.$http.get(this.nextURL).then(function (res) {
	                var data = res.data;
	
	                _this3.nextURL = data.next;
	                if (_lodash2.default.isNull(_this3.nextURL)) {
	                    _this3.$broadcast('$InfiniteLoading:noMore');
	                }
	
	                _this3.articles = _this3.articles.concat(data.results);
	            }).then(function () {
	                _this3.$broadcast('$InfiniteLoading:loaded');
	            });
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scriptjs = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueResource = __webpack_require__(42);
