...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/pages/Index.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/forms/LoginForm.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	    ...
	    methods: {
	        submit: function submit(e) {
	            ...
	            resource.login({}, this.$data).then(function (res) {
	                _this.$dispatch('logined', res.data);
	            }, function (res) {
	                if (res.status === 400) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/pages/Articles.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    route: {
	        data: function data(transition) {
	            ...
	            if (!_index.StrUtils.isContainedBy(category, _consts3.AVAILABLE_CATEGORIES)) category = 'government';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    isContainedBy: function isContainedBy(str, collections) {
	        return _lodash2.default.indexOf(collections, str) >= 0;
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/lists/ArticleList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/items/ArticleItem.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/navs/ArticleNavBar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CATEGORIES_NAME = ['政府', '公司', '媒体'];
	
	exports.default = {
	    data: function data() {
	        return {
	            categories: _lodash2.default.zipObject(_consts.AVAILABLE_CATEGORIES, CATEGORIES_NAME)
	        };
	    },
	    props: {
	        vertical: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.USER_TYPES = exports.AVAILABLE_CATEGORIES = undefined;
	...
	var AVAILABLE_CATEGORIES = exports.AVAILABLE_CATEGORIES = ['government', 'company', 'media'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/pages/ArticleEdit.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    ready: function ready() {
	        ...
	        (0, _scriptjs2.default)('//cdn.ckeditor.com/4.5.9/standard/ckeditor.js', function () {
	            _this.ckeditor = CKEDITOR.replace(_this.editorId);
	            _this.ckeditor.on('change', function () {
	                _this.model = _this.ckeditor.getData();
	            });
	        });
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/pages/ArticleDetail.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/components/pages/Profile.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	    ...
	    computed: {
	        hasUserData: function hasUserData() {
	            return !_lodash2.default.isNull(this.user.user_data);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Vue) {
	    Vue.filter('state', function (value) {
	        return _lodash2.default.isEmpty(value) ? '' : 'danger';
	    });
	};
