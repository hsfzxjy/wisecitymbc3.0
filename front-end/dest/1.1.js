...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = Vue;
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(96), __webpack_require__(97)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Vue) {
	    ...
	    router.map({
	        ...
	        '/finance': {
	            ...
	            subRoutes: {
	                '/': {
	                    component: _FinanceIndex2.default,
	                    name: 'finance-index'
	                },
	                '/stocks/': {
	                ...
	                '/bonds/': {
	                    component: _Bonds2.default,
	                    name: 'bond-list'
	                },
	                '/futures/': {
	                    component: _Futures2.default,
	                    name: 'futures-list'
	                }
	            }
	        },
	        '/ram/': {
	            component: _RAM2.default,
	            name: 'ram-index'
	        },
	        '*': {
	    ...
	    router.beforeEach(function (_ref) {
	        ...
	        if (to.auth) {
	            ...
	            } else return router.app.getPerm(to.auth.model, to.auth.action, parseInt(to.params.id) || undefined);
	        } else next();
	    });
	...
	var _Logout = __webpack_require__(117);
	...
	var _Tags = __webpack_require__(145);
	
	var _Tags2 = _interopRequireDefault(_Tags);
	
	var _ArticleDetail = __webpack_require__(150);
	
	var _ArticleDetail2 = _interopRequireDefault(_ArticleDetail);
	
	var _ArticleEdit = __webpack_require__(154);
	...
	var _Companies = __webpack_require__(180);
	
	var _Companies2 = _interopRequireDefault(_Companies);
	
	var _Notifications = __webpack_require__(183);
	...
	var _TopicEdit = __webpack_require__(195);
	
	var _TopicEdit2 = _interopRequireDefault(_TopicEdit);
	
	var _TopicDetail = __webpack_require__(198);
	
	var _TopicDetail2 = _interopRequireDefault(_TopicDetail);
	
	var _Finance = __webpack_require__(203);
	
	var _Finance2 = _interopRequireDefault(_Finance);
	
	var _FinanceIndex = __webpack_require__(208);
	
	var _FinanceIndex2 = _interopRequireDefault(_FinanceIndex);
	
	var _Stocks = __webpack_require__(232);
	
	var _Stocks2 = _interopRequireDefault(_Stocks);
	
	var _Bonds = __webpack_require__(235);
	
	var _Bonds2 = _interopRequireDefault(_Bonds);
	
	var _Futures = __webpack_require__(238);
	
	var _Futures2 = _interopRequireDefault(_Futures);
	
	var _RAM = __webpack_require__(241);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] js/components/pages/Index.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginForm = __webpack_require__(102);
	
	var _LoginForm2 = _interopRequireDefault(_LoginForm);
	
	var _ArticleListGroup = __webpack_require__(105);
	
	var _ArticleListGroup2 = _interopRequireDefault(_ArticleListGroup);
	...
	exports.default = {
	    components: {
	        ...
	        ArticleListGroup: _ArticleListGroup2.default
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/auth/LoginForm.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
	    ...
	    methods: {
	        submit: function submit(e) {
	            ...
	            resource.login({}, this.$data).then(function (res) {
	                _this.$root.$emit('logined', res.data);
	                _this.$root.$broadcast('logined', res.data);
	            });
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleListGroup.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ListLoader = __webpack_require__(109);
	
	var _ListLoader2 = _interopRequireDefault(_ListLoader);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = {
	    components: { ListLoader: _ListLoader2.default },
	    data: function data() {
	        return {
	            articles: []
	        };
	    ...
	    computed: {
	        params: function params() {
	            var params = _.cloneDeep(this.otherParams);
	
	            params.article_type = _consts.articles.ArticleType[this.category];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/ListLoader.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
	    ...
	    methods: {
	        load: function load() {
	            ...
	            this.$http.get(this.url, { params: this.params }).then(function (res) {
	                _this.model = res.data.results;
	                if (!_this.model.length) _this.$emit('ListLoader:no-results');
	            });
	        }
	    },
	    events: (0, _defineProperty3.default)({}, 'ListLoader:reload', function ListLoaderReload() {
	        this.load();
	    })
	};
...
/***/ function(module, exports) {
	...
	module.exports = "\n<vs-list-group :flush=\"flush\" _v-affb591a=\"\">\n    <vs-list-group-item v-for=\"article in articles\" class=\"ALGI\" _v-affb591a=\"\">\n        <div class=\"wrapper\" _v-affb591a=\"\">\n            <a v-link=\"article.url\" _v-affb591a=\"\">\n                {{ article.title }}\n            </a>\n            <vs-badge variant=\"success\" :id=\"'collapse-article-'+article.id\" class=\"pull-xs-right pointer ALGB\" _v-affb591a=\"\">\n                摘要\n            </vs-badge>\n            <vs-badge variant=\"danger\" class=\"pull-xs-right\" v-if=\"article.is_top\" _v-affb591a=\"\">\n                置顶\n            </vs-badge>\n        </div>\n        <vs-expansion :toggler-id=\"'collapse-article-'+article.id\" _v-affb591a=\"\">\n             <div class=\"card card-block\" slot=\"content\" _v-affb591a=\"\">\n                 {{ article.summary }}\n             </div>\n        </vs-expansion>\n    </vs-list-group-item>\n</vs-list-group>   \n<list-loader url=\"/api/articles/\" :params=\"params\" :model.sync=\"articles\" _v-affb591a=\"\">\n</list-loader>\n<slot name=\"no-results\" v-if=\"!articles.length\" _v-affb591a=\"\">\n    <div class=\"text-xs-center\" style=\"color: #eee;\" _v-affb591a=\"\">空空如也～～</div>\n</slot>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/auth/Login.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"col-md-6 col-md-offset-3 col-sm-12\">\n    <login-form @logined=\"logined\"></login-form>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/auth/Logout.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
	    route: {
	        data: function data(transition) {
	            ...
	            return this.$http.get('/api/users/logout/').then(function (res) {
	                _this.$root.$emit('logout');
	                _this.$root.$broadcast('logout');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/Articles.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleList = __webpack_require__(124);
	
	var _ArticleList2 = _interopRequireDefault(_ArticleList);
	
	var _ArticleNavBar = __webpack_require__(141);
	...
	exports.default = {
	    components: { ArticleList: _ArticleList2.default, ArticleNavBar: _ArticleNavBar2.default },
	    data: function data() {
	        return {
	            currentCategory: ''
	        };
	    ...
	    route: {
	        data: function data(transition) {
	            var category = transition.to.params.category;
	
	            if (!_index.StrUtils.isContainedBy(category, _consts.AVAILABLE_CATEGORIES)) category = 'government';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearObject = exports.StrUtils = undefined;
	...
	var clearObject = exports.clearObject = function clearObject(object) {
	    _.forEach(object, function (value, key) {
	        if (_.isArray(value)) object[key] = [];else if (_.isObject(value)) object[key] = {};else object[key] = '';
	    });
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    isContainedBy: function isContainedBy(str, collections) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleList.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleItem = __webpack_require__(128);
	
	var _ArticleItem2 = _interopRequireDefault(_ArticleItem);
	
	var _InfiniteLoadingMixin = __webpack_require__(138);
	...
	exports.default = {
	    ...
	    computed: {
	        ...
	        params: function params() {
	            ...
	            if (this.category) params.article_type = _consts.articles.ArticleType[this.category];
	    ...
	    events: (0, _defineProperty3.default)({}, 'ArticleList:reset', function ArticleListReset() {
	        this.reset();
	    })
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ArticleItem.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ArticleItem.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FileList = __webpack_require__(132);
	...
	exports.default = {
	    ...
	    methods: {
	        removeFile: function removeFile(index) {
	            ...
	            this.$http.delete("" + this.baseURL + id + "/").then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueInfiniteLoading = __webpack_require__(139);
	    ...
	    methods: {
	        ...
	        load: function load() {
	            ...
	            this.$http.get(url, { params: params }).then(function (res) {
	                ...
	                _this2.$broadcast('$InfiniteLoading:loaded');
	                if (_this2.once) _this2.$broadcast('$InfiniteLoading:noResults');
	            });
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleNavBar.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CATEGORIES_NAME = ['政府', '公司', '媒体', '交易', '能源及原材料'];
	
	exports.default = {
	    data: function data() {
	        return {
	            categories: _.zipObject(_consts.AVAILABLE_CATEGORIES, CATEGORIES_NAME)
	        };
	    },
	    props: {
	        vertical: {
	        ...
	        currentCategory: {
	            ...
	            coerce: function coerce(value) {
	                if (_.isNumber(value)) {
	                    ...
	                    _.forEach(_consts.articles.ArticleType, function (v, k) {
	                        if (v === value) key = k;
	                    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/Tags.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { ArticleList: _ArticleList2.default },
	    data: function data() {
	        return {
	            tags: [],
	            currentTagId: 0
	    ...
	    route: {
	        data: function data(transition) {
	            var id = transition.to.params.id || 0;
	
	            if (_.startsWith(transition.from.path, '/tags')) transition.next({ currentTagId: id });else return this.loadTags().then(function (res) {
	                return {
	                    tags: res.data.results,
	                    currentTagId: id
	                };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleDetail.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DetailMixin = __webpack_require__(152);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/articles/ArticleEdit.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5f0aaaf0&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ArticleEdit.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5f0aaaf0&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./ArticleEdit.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EditPageMixin = __webpack_require__(170);
	...
	exports.default = {
	    ...
	    methods: {
	        submitted: function submitted(editor, article) {
	            this.$router.go(article.url);
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/edit/Editor.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CKEditor = __webpack_require__(160);
	...
	exports.default = {
	    ...
	    computed: {
	        ...
	        dataToSubmit: function dataToSubmit() {
	            var obj = _.cloneDeep(this.model);
	
	            obj.attachments = _.map(this.model.attachments, function (file) {
	                return file.id;
	            });
	    ...
	    methods: {
	        submit: function submit() {
	            ...
	            this.$http[this.submitMethod](this.submitURL, this.dataToSubmit).then(function (res) {
	                ...
	                (0, _index.clearObject)(_this.model);
	                _this.$broadcast('CKEditor:reset');
	            });
	        },
	        removeFile: function removeFile(index) {
	            this.model.attachments.splice(index, 1);
	        },
	        insertFileToEditor: function insertFileToEditor(file) {
	            var html = void 0;
	
	            if (file.file_type === _consts.files.FileType.image) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/edit/CKEditor.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./CKEditor.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./CKEditor.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scriptjs = __webpack_require__(164);
	...
	exports.default = {
	    events: (_events = {}, (0, _defineProperty3.default)(_events, 'CKEditor:insert-data', function CKEditorInsertData(data) {
	        var ckeditor = CKEDITOR.instances[this.editorId];
	
	        ckeditor.insertHtml(data);
	    }), (0, _defineProperty3.default)(_events, 'CKEditor:reset', function CKEditorReset() {
	        var ckeditor = CKEDITOR.instances[this.editorId];
	    ...
	    ready: function ready() {
	        if (window.CKEDITOR) this.initEditor();else (0, _scriptjs2.default)('//cdn.ckeditor.com/4.5.9/standard/ckeditor.js', this.initEditor.bind(this));
	    },
	    ...
	    methods: {
	        initEditor: function initEditor() {
	            ...
	            console.log(CKEDITOR);
	            var ckeditor = CKEDITOR.replace(this.editorId, {
	                language: 'zh-CN',
	                removeButtons: 'Source,PasteFromWord,PasteText,Paste,Scayt,Image,Superscript,Subscript,About,Anchor',
	                toolbarGroups: [{ name: 'styles', groups: ['styles'] }, { name: 'basicstyles', groups: ['basicstyles', 'cleanup'] }, { name: 'clipboard', groups: ['clipboard', 'undo'] }, { name: 'editing', groups: ['find', 'selection', 'spellchecker', 'editing'] }, { name: 'links', groups: ['links'] }, { name: 'insert', groups: ['insert'] }, { name: 'forms', groups: ['forms'] }, { name: 'tools', groups: ['tools'] }, { name: 'document', groups: ['mode', 'document', 'doctools'] }, { name: 'others', groups: ['others'] }, { name: 'paragraph', groups: ['list', 'indent', 'blocks', 'align', 'bidi', 'paragraph'] }, { name: 'colors', groups: ['colors'] }, { name: 'about', groups: ['about'] }],
	                removePlugins: 'elementspath',
	                resize_enabled: false
	            });
	            ckeditor.on('change', function () {
	                _this.model = ckeditor.getData();
	            });
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/Uploader.vue: named exports in *.vue files are ignored.")}
	            ...
	            var init = {
	                ...
	                FileUploaded: function FileUploaded(up, file, info) {
	                    ...
	                    _this.$http.post(_this.fileAddUrl, { path: key }).then(function (res) {
	                        ...
	                        _this.$dispatch('file-uploaded', file);
	                    }).then(function () {
	                        _this.uploadStatus.uploading = false;
	                    });
	                },
	                UploadProgress: function UploadProgress(up, progress) {
	                    _this.uploadStatus.percent = progress.percent;
	                    _this.$dispatch('upload-progress', up, progress);
	                },
	                BeforeUpload: function BeforeUpload(up, file) {
	                    ...
	                    _this.$dispatch('before-upload', up, file);
	                }
	            };
	
	            _.forEach("FilesAdded Error UploadComplete".split(' '), function (eventName) {
	                init[eventName] = function () {
	                    var args = [_.kebabCase(eventName)].concat(Array.prototype.slice.call(arguments));
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"container\" _v-5f0aaaf0=\"\">\n    <editor v-if=\"!$loadingRouteData\" name=\"article-edit\" base-url=\"/api/articles/\" :model.sync=\"article\" @submitted=\"submitted\" _v-5f0aaaf0=\"\">\n        <vs-form-input :model.sync=\"article.title\" type=\"text\" name=\"title\" label=\"标题\" placeholder=\"标题\" slot=\"fields-before\" _v-5f0aaaf0=\"\">\n        </vs-form-input>\n        <vs-form-input :model.sync=\"tagsDisplay\" type=\"text\" name=\"tags\" label=\"标签\" help-text=\"以空格分隔\" placeholder=\"标签\" slot=\"fields-before\" _v-5f0aaaf0=\"\">\n        </vs-form-input>\n        <fieldset class=\"form-group\" slot=\"fields-after\" _v-5f0aaaf0=\"\">\n            <div class=\"checkbox\" _v-5f0aaaf0=\"\">\n                <label _v-5f0aaaf0=\"\">\n                    <input type=\"checkbox\" v-model=\"article.is_top\" _v-5f0aaaf0=\"\">\n                    置顶\n                </label>\n            </div>\n        </fieldset>\n    </editor>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/users/Profile.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReportList = __webpack_require__(174);
	...
	exports.default = {
	    ...
	    computed: {
	        ...
	        userTypeName: function userTypeName() {
	            return _consts.USER_TYPES[this.user.user_type];
	        },
	    ...
	    route: {
	        canActivate: function canActivate(transition) {
	            var id = transition.to.params.id;
	            return id === undefined || _index.StrUtils.isDigits(id);
	        },
	        data: function data(transition) {
	            var _this = this;
	
	            var id = transition.to.params.id || 'me';
	
	            return this.$http.get('/api/users/' + id + '/').then(function (res) {
	                _this.user = res.data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/users/Companies.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/notifications/Notifications.vue: named exports in *.vue files are ignored.")}
	...
	exports.default = {
	    ...
	    filters: {
	        render: function render(message) {
	            return message.replace(/\[(.*)\]\((.*)\)/g, function (ignore, text, url) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/Pager.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    events: (0, _defineProperty3.default)({}, 'Pager:refresh', function PagerRefresh() {
	        this.refresh();
	    })
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/questions/Topics.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TopicItem = __webpack_require__(191);
	...
	exports.default = {
	    components: { TopicItem: _TopicItem2.default, Pager: _Pager2.default },
	    data: function data() {
	        return {
	            page: {},
	            nextURL: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/questions/TopicItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/questions/TopicEdit.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/questions/TopicDetail.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    mixins: [_DetailMixin2.default],
	    components: { Editor: _Editor2.default, Pager: _Pager2.default },
	    detailConfig: {
	        baseURL: '/api/topics/',
	        objectFieldName: 'topic',
	        idFieldName: 'topicId'
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/Finance.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { ArticleListGroup: _ArticleListGroup2.default },
	    route: {
	        data: function data(transition) {
	            this.$broadcast('ListLoader:reload');
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/FinanceIndex.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StockItem = __webpack_require__(212);
	
	var _StockItem2 = _interopRequireDefault(_StockItem);
	
	var _BondItem = __webpack_require__(221);
	
	var _BondItem2 = _interopRequireDefault(_BondItem);
	
	var _FutureItem = __webpack_require__(226);
	
	var _FutureItem2 = _interopRequireDefault(_FutureItem);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	exports.default = {
	    components: { ListLoader: _ListLoader2.default, StockItem: _StockItem2.default, BondItem: _BondItem2.default, FutureItem: _FutureItem2.default },
	    data: function data() {
	        return {
	            stocks: [],
	            bonds: [],
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/StockItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { Chart: _Chart2.default },
	    data: function data() {
	        return {
	            chartSeries: {
	                price: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/Chart.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highstock = __webpack_require__(218);
	...
	exports.default = {
	    ...
	    events: (0, _defineProperty3.default)({}, 'Chart:init', function ChartInit() {
	        if (!this.initiated) this.init();
	    }),
	    methods: {
	        initChart: function initChart() {
	            var series = [];
	            _.forEach(this.series, function (item) {
	                return series[item.index] = {
	                    name: item.name
	                };
	            });
	
	            this.chart = _highstock2.default.StockChart(this.containerId, {
	                chart: {
	        ...
	        loadData: function loadData() {
	            ...
	            this.$http.get(this.url).then(function (_ref) {
	                var data = _ref.data;
	
	                _this.addData(data.results);
	                _this.url = data.next;
	            });
	        },
	        addData: function addData(data) {
	            ...
	            _.forEach(this.series, function (_ref2, fieldName) {
	                var index = _ref2.index;
	
	                var series = _this2.chart.series[index];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/BondItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.card hr[_v-81baadf6] {\n    margin: 0;\n}\n", "", {"version":3,"sources":["/./js/components/finance/BondItem.vue?7a00fd38"],"names":[],"mappings":";AAgCA;IACA,UAAA;CACA","file":"BondItem.vue","sourcesContent":["<template>\n    <div>\n        <vs-card>\n            <div class=\"card-block text-xs-center\">\n                <h3>\n                    {{ bond.name }}\n                </h3>\n                <dl class=\"clearfix\">\n                    <dt class=\"col-md-6\">价格</dt>\n                    <dd class=\"col-md-6\">{{ bond.price }}</dd>\n                    <dt class=\"col-md-6\">发行量</dt>\n                    <dd class=\"col-md-6\">{{ bond.quantity }}</dd>\n                </dl>\n            </div>\n            <vs-list-group flush>\n                <vs-list-group-item>\n                    发行方： {{ bond.issuer }}\n                </vs-list-group-item>\n                <vs-list-group-item\n                    class=\"no-padding\">\n                    <chart\n                        :url=\"'/api/bonds/'+bond.id+'/logs/?limit=5'\"\n                        :series.once=\"chartSeries\">\n                            \n                    </chart>\n                </vs-list-group-item>\n            </vs-list-group>\n        </vs-card>\n    </div>\n</template>\n\n<style scoped>\n    .card hr {\n        margin: 0;\n    }\n</style>\n\n<script>\n    import Chart from 'misc/Chart.vue'\n\n    export default {\n        components: { Chart },\n        data: () => ({\n            chartSeries: {\n                price: {\n                    name: '价格'\n                },\n                quantity: {\n                    name: '发行量'\n                }\n            }\n        }),\n        props: {\n            bond: {\n                type: Object,\n                required: true\n            }\n        }\n    }\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/FutureItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.card hr[_v-d8b2cb76] {\n    margin: 0;\n}\n", "", {"version":3,"sources":["/./js/components/finance/FutureItem.vue?2cdbe96d"],"names":[],"mappings":";AA2BA;IACA,UAAA;CACA","file":"FutureItem.vue","sourcesContent":["<template>\n    <div>\n        <vs-card>\n            <div class=\"card-block text-xs-center\">\n                <h3>\n                    {{ future.name }}\n                </h3>\n                <dl class=\"clearfix\">\n                    <dt class=\"col-md-6\">价格</dt>\n                    <dd class=\"col-md-6\">{{ future.price }}</dd>\n                </dl>\n            </div>\n            <vs-list-group flush>\n                <vs-list-group-item\n                    class=\"no-padding\">\n                    <chart\n                        :url=\"'/api/futures/'+'future.id'+'/logs/?limit=5'\"\n                        :series.once=\"chartSeries\">\n                            \n                    </chart>\n                </vs-list-group-item>\n            </vs-list-group>\n        </vs-card>\n    </div>\n</template>\n\n<style scoped>\n    .card hr {\n        margin: 0;\n    }\n</style>\n\n<script>\n    import Chart from 'misc/Chart.vue'\n\n    export default {\n        components: { Chart },\n        data: () => ({\n            chartSeries: {\n                price: {\n                    name: '价格'\n                }\n            }\n        }),\n        props: {\n            future: {\n                type: Object,\n                required: true\n            }\n        }\n    }\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/Stocks.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { Pager: _Pager2.default, StockItem: _StockItem2.default },
	    data: function data() {
	        return {
	            page: {}
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/Bonds.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { Pager: _Pager2.default, BondItem: _BondItem2.default },
	    data: function data() {
	        return {
	            page: {}
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/Futures.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    components: { Pager: _Pager2.default, FutureItem: _FutureItem2.default },
	    data: function data() {
	        return {
	            page: {}
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/RAM.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\nh3[_v-2d2dcf42] {\n    margin-bottom: 0.8rem;\n}\n", "", {"version":3,"sources":["/./js/components/finance/RAM.vue?27c23f5a"],"names":[],"mappings":";AA4BA;IACA,sBAAA;CACA","file":"RAM.vue","sourcesContent":["<template>\n    <div class=\"clearfix\">\n        <div class=\"col-xs-12 col-sm-6 col-md-8\">\n            <h3 style=\"color:#ccc\">原材料</h3>\n            <ram-item\n                v-if=\"page.results\"\n                v-for=\"item in page.results\"\n                :model=\"item\">\n            </ram-item>\n            <pager\n                :model.sync=\"page\"\n                url=\"/api/raw_materials/\">\n            </pager>\n        </div>\n        <div class=\"col-xs-12 col-sm-6 col-md-4\">\n            <h3 style='color:#ccc'>\n                资讯\n            </h3>\n            <article-list-group\n                category=\"energy_and_raw_materials\"\n                :other-params=\"{ limit: 10, fields: 'id,url,title,is_top,summary' }\"\n                :flush=\"true\">\n            </article-list-group>\n        </div>\n    </div>\n</template>\n\n<style scoped>\n    h3 {\n        margin-bottom: 0.8rem;\n    }\n</style>\n\n<script>\n    import ArticleListGroup from 'articles/ArticleListGroup.vue'\n    import RAMItem from './RAMItem.vue'\n    import Pager from 'misc/Pager.vue'\n\n    export default {\n        components: { ArticleListGroup, RAMItem, Pager },\n        data: () => ({\n            page: {}\n        }),\n        route: {\n            data (transition) {\n                this.$broadcast('ListLoader:reload')\n            }\n        }\n    }\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RAMItem = __webpack_require__(245);
	
	var _RAMItem2 = _interopRequireDefault(_RAMItem);
	...
	exports.default = {
	    components: { ArticleListGroup: _ArticleListGroup2.default, RAMItem: _RAMItem2.default, Pager: _Pager2.default },
	    data: function data() {
	        return {
	            page: {}
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/finance/RAMItem.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.card hr[_v-56f60adc] {\n    margin: 0;\n}\n", "", {"version":3,"sources":["/./js/components/finance/RAMItem.vue?03c6d2ea"],"names":[],"mappings":";AA2BA;IACA,UAAA;CACA","file":"RAMItem.vue","sourcesContent":["<template>\n    <div>\n        <vs-card>\n            <div class=\"card-block text-xs-center\">\n                <h3>\n                    {{ model.name }}\n                </h3>\n                <dl class=\"clearfix\">\n                    <dt class=\"col-md-6\">价格</dt>\n                    <dd class=\"col-md-6\">{{ model.price }}</dd>\n                </dl>\n            </div>\n            <vs-list-group flush>\n                <vs-list-group-item\n                    class=\"no-padding\">\n                    <chart\n                        :url=\"'/api/raw_materials/'+model.id+'/logs/?limit=5'\"\n                        :series.once=\"chartSeries\">\n                            \n                    </chart>\n                </vs-list-group-item>\n            </vs-list-group>\n        </vs-card>\n    </div>\n</template>\n\n<style scoped>\n    .card hr {\n        margin: 0;\n    }\n</style>\n\n<script>\n    import Chart from 'misc/Chart.vue'\n\n    export default {\n        components: { Chart },\n        data: () => ({\n            chartSeries: {\n                price: {\n                    name: '价格'\n                }\n            }\n        }),\n        props: {\n            model: {\n                type: Object,\n                required: true\n            }\n        }\n    }\n</script>"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global, _) {'use strict';
	...
	exports.default = function (Vue) {
	    ...
	    Vue.http.interceptors.push(function (request, next) {
	        if (!_.isUndefined(this.errors)) {
	            next(function (response) {
	                if (response.status === 400) this.errors = response.data;
	            });
	        } else next();
	    });
	};
	
	var _vueResource = __webpack_require__(254);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Vue) {
	    Vue.filter('state', function (value) {
	        return _.isEmpty(value) ? '' : 'danger';
	    });
	    Vue.filter('timesince', function (value) {
	        return timeSince(new Date(value + '+08:00')) + '前';
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Vue, callback) {
	    __webpack_require__.e/* nsure */(2, function (require) {
	        var vsBase = __webpack_require__(257);
	
	        _lodash2.default.forEach(vsBase, function (component, name) {
	            Vue.component('vs-' + _lodash2.default.kebabCase(name), component);
	        });
	
	        var vsFormButton = __webpack_require__(258);
	        var vsExpansion = __webpack_require__(261);
	        var Editable = __webpack_require__(264);
	        var BlockA = __webpack_require__(269);
	        var vsForm = __webpack_require__(274);
	
	        var SideBar = __webpack_require__(277);
