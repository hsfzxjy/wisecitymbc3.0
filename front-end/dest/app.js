	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        getPerm: function getPerm(model, action, id) {
	            ...
	            var name = this._getName(model, action, id);
	
	            if (!_.isUndefined(this.perms[name])) return new _promise2.default(function (resolve) {
	                resolve(_this4.perms[name]);
	            });else return this.loadPerms(model, id).then(function () {
	    ...
	    created: function created() {
	        ...
	        _promise2.default.all([this.$http.get('/api/users/me/'), this.resetPerms()]).then(function (_ref) {
	            var _ref2 = (0, _slicedToArray3.default)(_ref, 1);
	
	            var userRes = _ref2[0];
	
	            _this5.user = userRes.data;
	            console.log(_this5.perms);
	        }, _.noop);
	    },
