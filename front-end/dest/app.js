...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-401ee6be/TopNavBar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-42b61698/SideBarContent.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-42b61698&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SideBarContent.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-42b61698&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SideBarContent.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div _v-42b61698=\"\">\n    <div v-if=\"$root.user\" class=\"clearfix top-btn-group\" _v-42b61698=\"\">\n        <div class=\"col-xs-6\" _v-42b61698=\"\">\n            <vs-link link=\"/me/\" title=\"个人主页\" icon=\"user\" _v-42b61698=\"\"></vs-link>\n        </div>\n        <div class=\"col-xs-6\" _v-42b61698=\"\">\n            <vs-link link=\"/logout/\" title=\"退出\" icon=\"sign-out\" _v-42b61698=\"\"></vs-link>\n        </div>\n    </div>\n    <div v-else=\"\" class=\"clearfix\" _v-42b61698=\"\">\n        <vs-link link=\"/login/\" title=\"登录\" icon=\"sign-in\" _v-42b61698=\"\"></vs-link>\n    </div>\n    <vs-list-group flush=\"\" _v-42b61698=\"\">\n        <vs-list-group-item v-if=\"$root.perms.articles_article_add_\" _v-42b61698=\"\">\n            <vs-link link=\"/edit/articles/\" title=\"撰写\" icon=\"pencil\" _v-42b61698=\"\"></vs-link>\n        </vs-list-group-item>\n    </vs-list-group>\n    <vs-list-group flush=\"\" _v-42b61698=\"\">\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-expansion title=\"文章\" _v-42b61698=\"\">\n                <vs-list-group flush=\"\" slot=\"content\" _v-42b61698=\"\">\n                    <vs-list-group-item v-for=\"category in categories\" _v-42b61698=\"\">\n                        <vs-link :link=\"`/articles/${$key}/`\" :title=\"category\" _v-42b61698=\"\">\n                        </vs-link>\n                    </vs-list-group-item>\n                </vs-list-group>\n            </vs-expansion>\n        </vs-list-group-item>\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-expansion title=\"标签\" _v-42b61698=\"\">\n                <vs-list-group flush=\"\" slot=\"content\" _v-42b61698=\"\">\n                    <vs-list-group-item v-for=\"tag in tags\" _v-42b61698=\"\">\n                        <vs-link :link=\"tag.url\" icon=\"tag\" :title=\"tag.name\" _v-42b61698=\"\">\n                        </vs-link>\n                    </vs-list-group-item>\n                </vs-list-group>\n            </vs-expansion>\n        </vs-list-group-item>\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-link link=\"/companies/\" title=\"公司\" _v-42b61698=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-link link=\"/finance/\" title=\"交易\" _v-42b61698=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-link link=\"/ram/\" title=\"能源及原材料\" _v-42b61698=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item _v-42b61698=\"\">\n            <vs-link link=\"/topics/\" title=\"Q&amp;A\" _v-42b61698=\"\"></vs-link>\n        </vs-list-group-item>\n    </vs-list-group>\n</div>\n";
