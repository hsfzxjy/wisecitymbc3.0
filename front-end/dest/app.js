...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__.e/* nsure */(1, function (require) {
	    var Vue = __webpack_require__(95);
	    var router = __webpack_require__(98).default(Vue);
	    __webpack_require__(253).default(Vue);
	    __webpack_require__(255).default(Vue);
	    __webpack_require__(256).default(Vue, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/js/components/App.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TopNavBar = __webpack_require__(67);
	
	var _TopNavBar2 = _interopRequireDefault(_TopNavBar);
	
	var _SideBarContent = __webpack_require__(70);
	...
	exports.default = {
	    components: {
	        ...
	        SideBarContent: _SideBarContent2.default
	    },
	    data: function data() {
	        return {
	            user: null,
	    ...
	    methods: {
	        _getName: function _getName(model, action, id) {
	            return [model.replace('.', '_'), action, id || ''].join('_');
	        },
	        _extendPerms: function _extendPerms(perms) {
	            var _this = this;
	
	            _.forEach(perms, function (value, key) {
	                _this.$set('perms.' + key, value);
	            });
	        },
	        _loadAddPerms: function _loadAddPerms() {
	            var _this2 = this;
	
	            return this.$http.get('/api/perms/').then(function (res) {
	                return _this2._extendPerms(res.data);
	            });
	        },
	        loadPerms: function loadPerms(model, id) {
	            var _this3 = this;
	
	            return this.$http.get('/api/object_perms/' + model + '/' + id + '/').then(function (res) {
	                return _this3._extendPerms(res.data, id);
	            });
	        },
	        getPerm: function getPerm(model, action, id) {
	            var _this4 = this;
	
	            return this.initPromise.then(function () {
	                var name = _this4._getName(model, action, id);
	                console.log(name);
	
	                if (!_.isUndefined(_this4.perms[name])) return _this4.perms[name];else return _this4.loadPerms(model, id).then(function () {
	                    return _this4.perms[name];
	                }, function () {
	                    return false;
	                });
	            });
	        },
	        resetPerms: function resetPerms() {
	            var _this5 = this;
	
	            this.perms = {};
	            this.reseting = false;
	            return this._loadAddPerms().then(function () {
	                return _this5.reseting = false;
	            });
	        },
	    ...
	    created: function created() {
	        ...
	        return this.initPromise = _promise2.default.all([this.$http.get('/api/users/me/'), this.resetPerms()]).then(function (_ref) {
	            var _ref2 = (0, _slicedToArray3.default)(_ref, 1);
	
	            var userRes = _ref2[0];
	
	            _this7.user = userRes.data;
	        }, _.noop);
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/navs/TopNavBar.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/js/components/navs/TopNavBar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] js/components/misc/SideBarContent.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/hsfzxjy/srcs/wisecitymbc3.0/front-end/js/components/misc/SideBarContent.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7341e854&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SideBarContent.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-7341e854&scoped=true!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./SideBarContent.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        tagToggled: function tagToggled() {
	            var _this = this;
	
	            this.$http.get('/api/tags/').then(function (res) {
	                return _this.tags = res.data.results;
	            });
	        }
	    },
	    ready: function ready() {
	        ...
	        this.$http.get('/api/tags/', { params: { limit: 5 } }).then(function (res) {
	            return _this2.tags = res.data.results;
	        });
	    },
	
	    events: (0, _defineProperty3.default)({}, 'BlockA:click', function BlockAClick() {
	        this.$root.showSideBar = false;
	    })
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.USER_TYPES = exports.accounts = exports.files = exports.articles = exports.AVAILABLE_CATEGORIES = undefined;
	
	var _USER_TYPES;
	
	var _consts = __webpack_require__(80);
	...
	var AVAILABLE_CATEGORIES = exports.AVAILABLE_CATEGORIES = ['government', 'company', 'media', 'finance', 'energy_and_raw_materials'];
	
	var articles = exports.articles = _consts2.default.articles;
	var files = exports.files = _consts2.default.files;
	var accounts = exports.accounts = _consts2.default.accounts;
	
	var UserType = _consts2.default.accounts.UserType;
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div _v-7341e854=\"\">\n    <div v-if=\"$root.user\" class=\"clearfix top-btn-group\" _v-7341e854=\"\">\n        <div class=\"col-xs-6\" _v-7341e854=\"\">\n            <vs-link link=\"/me/\" title=\"个人主页\" icon=\"user\" _v-7341e854=\"\"></vs-link>\n        </div>\n        <div class=\"col-xs-6\" _v-7341e854=\"\">\n            <vs-link link=\"/logout/\" title=\"退出\" icon=\"sign-out\" _v-7341e854=\"\"></vs-link>\n        </div>\n    </div>\n    <div v-else=\"\" class=\"clearfix top-btn-group\" _v-7341e854=\"\">\n        <vs-link link=\"/login/\" title=\"登录\" icon=\"sign-in\" _v-7341e854=\"\"></vs-link>\n    </div>\n    <vs-list-group flush=\"\" _v-7341e854=\"\">\n        <vs-list-group-item v-if=\"$root.perms.articles_article_add_\" _v-7341e854=\"\">\n            <vs-link link=\"/edit/articles/\" title=\"撰写\" icon=\"pencil\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item v-if=\"$root.user.is_staff\" _v-7341e854=\"\">\n            <vs-link link=\"/admin/\" title=\"后台管理\" icon=\"building\" ext=\"\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n    </vs-list-group>\n    <vs-list-group flush=\"\" _v-7341e854=\"\">\n        <vs-list-group-item _v-7341e854=\"\">\n            <vs-expansion title=\"资讯\" _v-7341e854=\"\">\n                <vs-list-group flush=\"\" slot=\"content\" _v-7341e854=\"\">\n                    <vs-list-group-item v-for=\"category in categories\" _v-7341e854=\"\">\n                        <vs-link :link=\"'/articles/'+$key+'/'\" :title=\"category\" _v-7341e854=\"\">\n                        </vs-link>\n                    </vs-list-group-item>\n                </vs-list-group>\n            </vs-expansion>\n        </vs-list-group-item>\n        <vs-list-group-item _v-7341e854=\"\">\n            <vs-expansion title=\"标签\" _v-7341e854=\"\">\n                <vs-list-group flush=\"\" slot=\"content\" _v-7341e854=\"\">\n                    <vs-list-group-item v-for=\"tag in tags\" _v-7341e854=\"\">\n                        <vs-link :link=\"tag.url\" icon=\"tag\" :title=\"tag.name\" _v-7341e854=\"\">\n                        </vs-link>\n                    </vs-list-group-item>\n                    <vs-list-group-item _v-7341e854=\"\">\n                        <vs-link :link=\"'/tags/'\" title=\"更多...\" _v-7341e854=\"\">\n                        </vs-link>\n                    </vs-list-group-item>\n                </vs-list-group>\n            </vs-expansion>\n        </vs-list-group-item>\n        <vs-list-group-item _v-7341e854=\"\">\n            <vs-link link=\"/companies/\" title=\"公司\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item _v-7341e854=\"\">\n            <vs-link link=\"/finance/\" title=\"交易\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item _v-7341e854=\"\">\n            <vs-link link=\"/ram/\" title=\"能源及原材料\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n        <vs-list-group-item v-if=\"$root.questions_topic_view_\" _v-7341e854=\"\">\n            <vs-link link=\"/topics/\" title=\"Q&amp;A\" _v-7341e854=\"\"></vs-link>\n        </vs-list-group-item>\n    </vs-list-group>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/sass-loader/index.js!./bootstrap.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/sass-loader/index.js!./bootstrap.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./node_modules/css-loader/index.js!./node_modules/sass-loader/index.js!./node_modules/font-awesome-sass-loader/font-awesome-sass-styles.loader.js!./font-awesome.config.js", function() {
				var newContent = require("!!./node_modules/css-loader/index.js!./node_modules/sass-loader/index.js!./node_modules/font-awesome-sass-loader/font-awesome-sass-styles.loader.js!./font-awesome.config.js");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
