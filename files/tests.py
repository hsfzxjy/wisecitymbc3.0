...
class FileTestCase(APITestCase):
    ...
    def test_create_txt(self):
        key = utils.upload_file('./files/test_files/testfile.txt')
    ...
    def test_create_image(self):
        key = utils.upload_file('./files/test_files/testimage.jpg')
        res = self.client.post('/api/files/', {
            'path': key
        }, format='json')
    ...
    def test_create_video(self):
        key = utils.upload_file('./files/test_files/movie.ogg')
        res = self.client.post('/api/files/', {
            'path': key
        }, format='json')
...
class FileRetrieveTestCase(APITestCase):
    ...
    def test_download(self):
        self.key = utils.upload_file('./files/test_files/testfile.txt')
